...
**** DONE Gokyo
  ...
  Die Gokyo-no-waza ist der Standardlehrplan der Judo-Wurftechniken und wurde 1895 ins Leben gerufen. Von 1920
...
**** DONE Vom Kodokan anerkannt
  ...
  Judo-Würfe anerkannt (shinmeisho-no-waza). 1997 fügte der Kodokan die letzten zwei zusätzlichen Würfe der
  shinmeisho-no-waza hinzu.
...
**** DONE Weitere bekannte Techniken im JVB
 ...
 + O-uchi-barai
 + Tawara-guruma
 + Te-guruma (lt. Kodokan zählt dieser Wurf zu Sukui-nage)
 + Tomoe-maki-komi
 + Tomoe-otoshi
 + Ude-gaeshi
 + Ude-hiza-guruma
...
*** TODO <<<Ashi-waza>>> (Bein- und Fußwürfe) [0/10]
...
**** TODO O-soto-gaeshi
**** TODO O-uchi-gaeshi
**** TODO Hane-goshi-gaeshi
**** TODO Harai-goshi-gaeshi
**** TODO Uchi-mata-gaeshi

*** TODO Koshi-waza (Hüftwürfe) [0/2] 
...
*** TODO Te-waza (Hand- und Armwürfe) [0/4]
...
**** TODO Seoi-nage (背負投, Schulterwurf)
...
**** TODO Uki-otoshi (Schwebehandzug) 
...
*** TODO Yoko-sutemi-waza (Selbstfallwürfe zur Seite) [0/5]
...
**** TODO Yoko-gake (Seitliches Einhängen)
...
**** TODO Soto-maki-komi (Außendrehwurf)
...
**** TODO Hane-maki-komi (Springdrehwurf)
...
*** TODO Ma-sutemi-waza (Selbstfallwürfe nach hinten) [0/2]
...
**** TODO Tomoe-nage (Kreiswurf/ Überkopfwurf)
...
**** TODO Kuchiki-taoshi (einen morschen Baum fällen)
 Dieser Wurf wird offiziell in Gruppe der Te-waza eingruppiert.

**** TODO Morote-gari/Ryo-(te)-ashi-dori (Beidhandsichel)
...
*** TODO Ko-uchi-gari [0/2]

**** TODO Standard

**** TODO Keiji Suzuki

*** TODO O-soto-gari [0/2]

**** TODO Standard

**** TODO Gegenwurf O-soto-gari

** TODO Einhängen (Gake) [0/2]
...
*** TODO Ko-soto-gake [0/2]

**** TODO Standard

**** TODO Kombi O-soto-gari

*** TODO Yoko-gake [0/2]

**** TODO Standard

**** TODO Kombi Uchi-mata

** TODO Blockieren/Stoppen [0/2]
...
*** TODO Hiza-guruma [0/2]

**** TODO Standard

**** TODO Gegenwurf Hiza-guruma

*** TODO Ashi-guruma [0/2]

**** TODO Standard

**** TODO Kawaishi-Eingang

** TODO Verwringen/Rotieren lassen [0/2]
...
*** TODO Ippon-seoi-nage [0/2]

**** TODO Standard

**** TODO Finte Ko-uchi-barai

*** TODO Tsuri-komi-goshi [0/2]

**** TODO Standard

**** TODO Sode-tsuri-komi-goshi

** TODO Einrollen (Maki-komi) [0/2]

Tori rollt sich um einen Arm oder ein Bein ein (Maki-komi) und überträgt durch weiterrollen die Kraft
auf Uke.

*** TODO Soto-maki-komi [0/2]
**** TODO Standard
**** TODO Kombi Harai-goshi
*** TODO Ko-uchi-maki-komi [0/2]
**** TODO Standard

**** TODO Ippon-seoi-nage
...
** TODO Selbstfallen/Opfern (Sutemi) [0/2]
...
**** TODO Standard
**** TODO Yoko-tomoe-nage

*** TODO Yoko-sumi-gaeshi [0/2]
...
Siehe auch [[https://de.wikipedia.org/wiki/Judo#Geschichte][de.wikipedia.org/wiki/Judo#Geschichte]]
