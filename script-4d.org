...
- Kata-ha-jime - /Würgen unter Festlegung von Arm bzw. Schulter/
  ...
  4. <<<Othen-Jime>>>
     ...
     - die linke Hand geht unter Ukes linker Achsel hindurch und er rollt nach schräg vorne über und würgt, wobei ein Arm mit dem Bein und das andere mit dem Arm fixiert sind
...
- Kannuki-gatame - /den Arm mit den Unterarmen verriegeln und hebeln/
  ...
  4. <<<Kami-shiho-kannuki-gatame>>> 
     - Kuzure-kami-shiho gatame den Arm strecken, der andere Arm fasst den Oberarm, durch Verriegelung hebeln
...
[fn:verteidigung] Verteidigung (V), Angriff (A), aktiv (a), passiv (p)
...
+ Passives Verteidigen 
  1. Flach auf den Bodenlegen (Einigeln)
...
+ von der Seite
  ...
  2. Sode-jime (Sode-kuruma-jime in \citep[S. 86]{komuro2011komlock})
     - linkes Bein klammert, linker Arm greift durch Uke auf seine rechte Schulter, rechter Arm kontrolliert die Hüfte (fixieren)
     - Griff ins eigene rechte Revers und würgen
+ Von vorn
  1. Kami-sankaku-gatame (Kraftverhältnisse, Gewicht und Hebelgesetze)

** TODO <<<Bankstellung>>> [0/2]

*** TODO Verteidigung

+ Passives Verteidigen
  1. Einschränken der Bewegungsfreiheit und damit den Weg zur Ausführung der Technik versperren
     - Festhalten des angreifenden Arms bzw. Hand
     - fixieren des Beines
     - fixieren der Hüfte durch zur Seite rollen
+ Aktives Verteidigen
  1. Tori greift unter dem Arm durch - von der Seite: Ura-Gatame (Gurke)
  ...
  2. Tori greift unter dem Arm durch - von vorn: Gyaku-waki-gatame \citep[S. 46]{kashiwazaki2012einführung}
     - Arm fest an sich heranziehen und über dem Ellenbogen Toris fixieren
...
+ von vorn
  ...
  2. Sankaku-garami (Huizinga-Rolle)
     ...
     - Durchschwingen
     - Ausnutzen der Hebelgesetze (ganzer Körper)

** TODO <<<Zwischen den Beinen>>> [2/2]

*** DONE Verteidigung 
    CLOSED: [2018-11-22 Thu 09:07]
...
+ Passives Verteidigen
  1. Eine Seite des Angreifers fixieren
     ...
     - diagonal über den Rücken in Ukes Gürtel greifen 
+ Aktives Verteidigen
  ...
  2. Durchsteigen
     ...
     - mit den Ellenbogen die Oberschenkel auseinander drücken und mit den Knie zuerst durchsteigen (wenn man rechts durchsteigt, dann das linke Knie zuerst, sonst kann der Gegner klammern)
  3. Ebi-Jime
  ...
  4. Ansatz von Daki-age (Ausheber)
     - um den Angriff zu unterbrechen (Mate)
+ Aktives Verteidigen in Unterlage
  1. flexibles Unterschenkelkreisen
     - durch fixieren der Ellenbogen verhindert man, dass Uke vorbei geht oder anderweitig angreifen kann
...
** TODO <<<Beinklammer>>> [2/2]
   
*** DONE Verteidigung
    CLOSED: [2018-11-20 Tue 18:34]

+ Passives Verteidigen
  1. Bein klammern und mit den Armen den Partner fest umklammern (Immobilisation)
